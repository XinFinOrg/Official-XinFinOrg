                ...
                <div id="network" class="tab-pane fade in active">
                    ...
                    <div class="flex-row mt-2">
                        <div class="col-lg-6 col-md-6 col-sm-6 mt-3 mb-1">
                            <div class="configurationsBox pb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col" id="download-icon-boxes">
                                        <a href="https://play.google.com/store/apps/details?id=com.xdcwallet" target="_blank">
                                            <div><img src="assets/images/mobile-wallet-icon.png" /><span>Mobile Wallet</span></div>
                                        </a>
                                    </div>
                                    <div class="col" id="download-icon-boxes">
                                    ...
                                    <div class="col" id="download-icon-boxes">
                                        <a href="setup-masternode">
                                            <div><img src="assets/images/oneclick-installer-icon.png" /><span>One-Click Node Installer</span></div>
                                        </a>
                                    </div>
                                    <div class="col" id="download-icon-boxes">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mt-3 mb-1">
                            <div class="configurationsBox pb-0">
                                ...
                                <div class="row">
                                    <div class="col" id="download-icon-boxes">
                                        <a href="https://apothem.network/#getTestXDC" target="_blank">
                                            <div><img src="assets/images/faucet-icon.png" /><span>Faucet</span></div>
                                        </a>
                                    </div>
                                    <div class="col" id="download-icon-boxes">
                                        <a href="https://xinfin.network/#webWallet" target="_blank">
