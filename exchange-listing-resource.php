...
<section id="xdce" class="exchange-listing">
	  ...
	  <div class="row pb-1">
          <div class="col-md-12">
			...
			<p><a href="https://www.apothem.network/" target="_blank"><button class="btn-hover color-1">Sandbox/Test Network</button></a> <a href="https://www.apothem.network/#getTestXDC" target="_blank"><button class="btn-hover color-3 mt-1">Get free test XDC</button></a></p>
...
> '0x1234567891011121314151617181920212223456'</code></pre>
			...
			<div style="margin-left:20px;">
				...
				<ul style="margin-left:20px;">
					...
					<li><code>signTransaction(tx [, callback]) - Function</code> : The function to sign transactions. See <a href="https://web3js.readthedocs.io/en/v1.2.0/web3-eth-accounts.html#eth-accounts-signtransaction" target="_blank">web3.eth.accounts.signTransaction()</a> for more.</li>
					<li><code>sign(data) - Function</code> : The function to sign transactions. See <a href="https://web3js.readthedocs.io/en/v1.2.0/web3-eth-accounts.html#eth-accounts-sign" target="_blank">web3.eth.accounts.sign()</a> for more.</li>
				</ul>
...
> {
    ...
    encrypt: function(password){...}
			...
			<div style="margin-left:20px;">
				<p class="mt-2 mb-1"><strong>Parameters</strong></p>
				<ul style="margin-left:20px;">
					<li><code>string</code> - A block number or hash. Or the string <code>"genesis", "latest"</code> or <code>"pending"</code> as in the <a href="https://web3js.readthedocs.io/en/v1.2.0/web3-eth.html#eth-defaultblock" target="_blank">default block parameter</a>.</li>
    ...
    "input": "0x57cb2fc4"
			...
			<div style="margin-left:20px;">
				...
				<ul style="margin-left:30px;">
					...
					<li><code>"confirmation"</code> returns <code>Number, Object</code> : Is fired for every confirmation up to the 12th confirmation. Receives the confirmation number as the first and the <a href="https://web3js.readthedocs.io/en/v1.2.0/web3-eth.html#eth-gettransactionreceipt-return" target="_blank">receipt</a> as the second argument. Fired from confirmation 0 on, which is the block where its minded.</li>
