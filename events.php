...
<section class="px-80 bg-lightgray">
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-lg-10 offset-lg-1">
                <h1 class="title-m text-center mb-3">Past XDC.dev Events</h1>
                <h2 class="subtitle subtitle-s fw-500 text-center mb-0">S2308, Emirates Financial Towers, DIFC, Dubai UAE.</h2>
            </div>
        </div>
        ...
        <div class="row row-flex mt-4">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://lu.ma/MH-DAO-03-Lawblocks" target="_blank" class="events-card h-100 card bg-gray br-20 border-0">
                            <div class="">
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://lu.ma/MH-DAO-05-WEB3AI" target="_blank" class="events-card h-100 card bg-gray br-20 border-0">
                            <div class="">
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://lu.ma/bd_xdc.class.dubai" target="_blank" class="events-card h-100 card bg-gray br-20 border-0">
                            <div class="">
