            ...
            <div class="col-lg-12">
                <div class="row justify-content-center">                    
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://deca.org.au/2025policyforum/" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://www.asia.token2049.com/" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                            	<img src="assets/images/inside-page/events/DECon2025.jpg" class="img-fluid" alt="TOKEN2049 SINGAPORE" />
                                <div class="ftr-arrow">
                                    <svg class="w-6 h-6 icon ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
