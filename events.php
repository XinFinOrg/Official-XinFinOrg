            ...
            <div class="col-lg-12">
                <div class="row justify-content-center">                    
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://stg-3.com/event/rwa-london-summit/" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://asia.money2020.com/" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                            	<img src="assets/images/inside-page/events/money2020_bangkok2025.jpg" class="img-fluid" alt="HONG KONG FINTECH WEEK'24" />
                                <div class="ftr-arrow">
                                    <svg class="w-6 h-6 icon ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://www.ethdubaiconf.org/" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                            	<img src="assets/images/inside-page/events/ethdubai_2025.jpg" class="img-fluid" alt="HONG KONG FINTECH WEEK'24" />
                                <div class="ftr-arrow">
                                    <svg class="w-6 h-6 icon ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://www.dubai.token2049.com/" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                            	<img src="assets/images/inside-page/events/token2049_dubai2025.jpg" class="img-fluid" alt="HONG KONG FINTECH WEEK'24" />
                                <div class="ftr-arrow">
                                    <svg class="w-6 h-6 icon ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://www.deconference.com.au/" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                            	<img src="assets/images/inside-page/events/DECon2025.jpg" class="img-fluid" alt="The Digital Economy Conference" />
                                <div class="ftr-arrow">
                                    <svg class="w-6 h-6 icon ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg>
                            ...
                            <div class="events-card_content-wrapper">
                                <div class="events-card_content">
                                    <h4 class="card-infoHead">The Digital Economy Conference</h4>
                                    <div class="events-card_details-wrapper card-info">
                                        <div class="events-card_details">
                                            <div class="icon-1x1-small">
                                                <svg width="auto" height="auto" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="container">
        ...
        <div class="row row-flex mt-4">
            <div class="col-lg-12">
                <div class="row justify-content-center">                    
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://lu.ma/shoia4tm" target="_blank" class="events-card h-100 card bg-lightgray br-20 border-0">
                            <div class="">
                ...
                <div class="row justify-content-center">                    
                    ...
                    <div class="col-lg-4 col-md-6 mt-2 mb-3">
                        <a href="https://www.aciti.org.au/international-trade-and-finance-in-the-digital-economy" target="_blank" class="events-card h-100 card bg-darkgray br-20 border-0">
                            ...
                            <div class="events-card_content-wrapper">
                                <div class="events-card_content">
                                    <h4 class="card-infoHead">ACITI</h4>
                                    <div class="events-card_details-wrapper card-info">
                                        <div class="events-card_details">
                                            <div class="icon-1x1-small">
                                                <svg width="auto" height="auto" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
