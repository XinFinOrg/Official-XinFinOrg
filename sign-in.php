...
<html lang="en">
  ...
  <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand" href="sign-in.php"><img src="assets/images/logo.png" class="img-responsive" width="60"></a>
    </div>
    ...
    <section id="ewallet">
       <div class="home-form signin-form">
           <form action="" id="ewalletform" class="ewalletform" name="ewalletform">
                ...
                <span id="mainCaptcha">U p  z c x c W</span>
                <input type="text" name="captcha" id="captcha" class="form-control captcha" placeholder="Enter text written above" required>
                <p class="sign-in">By signing in, You indicate that you have read, understood and agree to our <a href="http://www.xinfin.org/terms-and-conditions/" target="_blank">T&C</a>, <a href="http://www.xinfin.org/disclaimer/" target="_blank">Disclaimer</a> & <a href="http://www.xinfin.org/privacy-policy/" target="_blank">Privacy Policy</a> </p>
                <input type="submit" name="submit" id="home-btn" class="home-btn" value="Sign In">
           </form>
           <h4><a href="https://ewallet.xinfin.org/forgot" target="_blank">Forgot/Reset Password?</a></h4>
        </div>
