<?php 
$title = "XinFin: Logo & Brand Assets Downloads";
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12 bannertext text-center">
				<h1>BRAND ASSETS</h1>
				<p>If you are looking for the XinFin brand assets you are in the right place. The XinFin logo usage is outlined below.<br />If you'd prefer to save some time just download the .zip file below.</p>
