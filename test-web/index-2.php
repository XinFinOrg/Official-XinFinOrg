        ...
        <div class="col-md-10 col-md-offset-1">
          <div style="display:block;position:relative">
            <div class="text-center wow fadeInDown" data-wow-duration="0.5s" data-wow-delay="0.5s">
              <h1 style="padding-left:0px;text-align:center;text-transform:none;">eXchange inFinite (XinFin) is a hybrid/decentralized Blockchain platform that runs smart contracts and Provides cross chain interoperability Which Combining the power of Public and Private blockchains.</h1>
