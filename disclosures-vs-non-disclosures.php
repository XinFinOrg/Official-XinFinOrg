	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12 bannertext">
                ...
                <p>XinFin [XDC] Network is a fully open source and community driven project. The XDC community runs 95% of the masternodes. XinFin project aims to be a fully transparent and decentralised infrastructure/platform for regulated financial institutions to host their products and services.</p>
			</div>
