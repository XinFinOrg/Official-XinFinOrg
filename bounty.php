	...
	<div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 bannertext">
				...
				<p>Check out the <a href="https://howto.xinfin.org/" target="_blank">Developer Information Center</a> for technical documentation and <a href="https://t.me/XinFinDevelopers" target="_blank">Official Telegram Developer Channel</a> to find the development resources.</p>
            </div>    
        </div>
    </div>
</section>
  ...
  <div class="container">
	...
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
        <div class="bounty-box">
			...
			<div class="btn-block mb-1">
				<a href="https://docs.google.com/forms/d/1api3woqg6oY4Lk7sRL2fnaBj8etfB-XF6fZNKLU6zFo" target="_blank"><button class="btn-hover color-1">Apply</button></a>
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
        <div class="bounty-box">
			...
			<div class="btn-block mb-1">
				<a href="https://docs.google.com/forms/d/1SklUqUFpncyj2GqYT48qR6sgC3jYMkvuCBy_UVDLovw" target="_blank"><button class="btn-hover color-1">Apply</button></a>
    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
        <div class="bounty-box">
			...
			<div class="btn-block mb-1">
				<a href="https://docs.google.com/forms/d/1sWgbJgVOnAJtxqOWePiAXg9hsIK-e06Jn0KtyoHjcZE" target="_blank"><button class="btn-hover color-1">Apply</button></a>
	...
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
        <div class="bounty-box">
			...
			<div class="btn-block mb-1">
				<a href="https://docs.google.com/forms/d/1XNrF7Kg7JgmYD3qDN3hZ6B895zeT8ZD2CAg8F9L0h_A" target="_blank"><button class="btn-hover color-1">Apply</button></a>
    ...
    <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="bounty">
				<p>If you already have solidity smart contracts, you can deploy them on XinFin.Network to be eligible for free XDC coin bounty. Interesting DApps will have provisions to get marketing grants on top of the bounty.</p>
				<p class="sub-header-small mb-2">Bounty Terms:</p>
                                ...
                                <ul>
                                    <li>Deploy the contract on XinFin.Network <a href="https://medium.com/xinfin/deploy-smart-contract-on-xinfin-testnet-through-xinfin-remix-and-xinpay-dfbbf9dcc3f7" target="_blank">How to Deploy contract on XDC network</a>?</li>
				...
				<div class="btn-block mt-3 mb-1">
					<a href="https://docs.google.com/forms/d/1qU9Oel-JgUskpZg8SSo2qDi7NvjhvsTy9p5G8a_9b3o" target="_blank"><button class="btn-hover color-1 btn-block">Apply For Bounty</button></a>
				</div>
				</div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="linkbox">
					...
					<p><a href="https://support.google.com/websearch/answer/6307673?hl=en" target="_blank"><button class="btn-hover color-3" data-toggle="modal" data-target="#exampleModalCenter">Click Here</button></a></p>
				</div>
				...
				<div class="btn-block mt-3 mb-1">
					<a href="https://docs.google.com/forms/d/1api3woqg6oY4Lk7sRL2fnaBj8etfB-XF6fZNKLU6zFo" target="_blank"><button class="btn-hover color-1 btn-block">Apply For Bounty</button></a>
				</div>
				</div>
            </div>
            <div class="modal-footer"></div>
    ...
    <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="btn-block mt-3 mb-1">
					<a href="https://docs.google.com/forms/d/1SklUqUFpncyj2GqYT48qR6sgC3jYMkvuCBy_UVDLovw" target="_blank"><button class="btn-hover color-1 btn-block">Apply For Bounty</button></a>
				</div>
				</div>
            </div>
            <div class="modal-footer"></div>
    ...
    <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="btn-block mt-3 mb-1">
					<a href="https://docs.google.com/forms/d/1sWgbJgVOnAJtxqOWePiAXg9hsIK-e06Jn0KtyoHjcZE/" target="_blank"><button class="btn-hover color-1 btn-block">Apply For Bounty</button></a>
				</div>
				</div>
            </div>
            <div class="modal-footer"></div>
    ...
    <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="btn-block mt-3 mb-1">
					<a href="https://docs.google.com/forms/d/1XNrF7Kg7JgmYD3qDN3hZ6B895zeT8ZD2CAg8F9L0h_A" target="_blank"><button class="btn-hover color-1 btn-block">Apply For Bounty</button></a>
				</div>
				</div>
            </div>
            <div class="modal-footer"></div>
