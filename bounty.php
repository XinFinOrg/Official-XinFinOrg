            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">From 10% to 20% XDC as per category applied</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 120% XDC of technical integration cost</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 10% XDC of the bounty distribution</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 120% XDC of the project fees</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 120% XDC of the legal opinion fees in your jurisdiction</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 120% XDC of cost incurred</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 120% XDC of the Crypto custodian Technical Iintegration fees</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 120% XDC of the hardware/software wallet Technical Integration fees</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-3">
                ...
                <div class="bounty-box">
                    ...
                    <div class="content">
                        ...
                        <h4 class="highlight small">Up to 120% XDC of the Exchange Technical Integration fees</h4>
                        ...
                        <div class="bounty">
                            ...
                            <div class="orderList">
                                <ol>
                                    ...
                                    <li>Post on any social media about your tasks and bounty applied in detail. Add the link of your social media post in the (Description & Proof Links or Google Drive Link with all possible details)</li>
                                </ol>
                            </div>
                            <p class="text-small">
                        ...
                        <div class="bounty">
                            ...
                            <div class="orderList">
                                <ol>
                                    ...
                                    <li>You will get reimbursement for up to 120% of the fees incurred in your wallet.</li>
                                    <li>Post on any social media about your tasks and bounty applied in detail. Add the link of your social media post in the (Description & Proof Links or Google Drive Link with all possible details)</li>
                                </ol>
                            </div>
                            <div class="btn-block mt-3 mb-1">
                        ...
                        <div class="bounty">
                            ...
                            <div class="orderList">
                                <ol>
                                    ...
                                    <li>You will get reimbursement for upto 120% of the fees incurred in your wallet.</li>
                                    <li>Post on any social media about your tasks and bounty applied in detail. Add the link of your social media post in the (Description & Proof Links or Google Drive Link with all possible details)</li>
                                </ol>
                            </div>
                            <div class="btn-block mt-3 mb-1">
                        ...
                        <div class="bounty">
                            ...
                            <div class="orderList">
                                <ol>
                                    ...
                                    <li>You will get upto 120% of the tech integration fees in your wallet.</li>
                                    <li>Post on any social media about your tasks and bounty applied in detail. Add the link of your social media post in the (Description & Proof Links or Google Drive Link with all possible details)</li>
                                </ol>
                            </div>
                            <div class="btn-block mt-3 mb-1">
            ...
            <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="bounty">
                            <p>
                                To support the innovation of the Community, XinFin Plans to run memes bounty. Meme needs to be informative and attractive. The memes getting the maximum number of likes, shares, and retweets will be awarded
                                XDC. Every participant needs to fill the bounty form to claim their rewards. Only the top 10 users will receive 5000 XDC each.
                            </p>
        ...
        <div class="modal fade bs-example-modal-lg" id="exampleModalCenter-4" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title" id="exampleModalCenterTitle">Deploy Solidity Contract on XinFin Mainnet (DSCXM Bounty)</h3>
                    </div>
                    <div class="modal-body">
                        <div class="bounty">
                            <p>
                                If you already have solidity smart contracts, you can deploy them on XinFin.Network to be eligible for free XDC coin bounty. Interesting DApps will have provisions to get marketing grants on top of the
                                bounty.
                            </p>
                            <p class="sub-header-small mb-2">Bounty Terms:</p>
                            <div class="orderList">
                                <ol>
                                    <li>Any current Solidity Smart Contract is eligible for the bounty.</li>
                                    <li>Contract deployment URL and website URL is mandatory.</li>
                                    <li>Share over social media post the deployment of the smart contract. And tag XinFin / XDC Coin in comment.</li>
                                    <li>Bounty starts from XDC coins worth USD 25 onwards.</li>
                                    <li>The committee reserves all rights to reject a bounty claim.</li>
                                    <li>The team will reject the application if the same candidate applies multiple times.</li>
                                    <li>Bounty will be given as an XDC coin</li>
                                    <li>Post on any social media about your tasks and bounty applied in detail. Add the link of your social media post in the (Description & Proof Links or Google Drive Link with all possible details)</li>
                                </ol>
                            </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <a href="https://medium.com/xinfin/deploy-smart-contract-on-xinfin-testnet-through-xinfin-remix-and-xinpay-dfbbf9dcc3f7" target="_blank">How to Deploy contract on XDC network</a>?
                                </li>
                                <li>
                                    Make an announcement on your official social media handle (Twitter/Linkedin) or make a PressRelease/Blog/BitcoinTalk post by tagging XinFin handle and adding relevant images and the keywords #XDC #XinFin
                                    #developer)
                                </li>
        ...
        <div class="modal fade bs-example-modal-lg" id="exampleModalCenter-5" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title" id="exampleModalCenterTitle">XinFin Android Wallet Bug Bounty</h3>
                    </div>
                    <div class="modal-body">
                        <div class="bounty">
                            ...
                            <p>
                                <a href="https://play.google.com/store/apps/details?id=com.xdcwallet" target="_blank"><img class="aligncenter" src="assets/images/android-google-play.png" alt="" width="202" height="60" /></a>
                            </p>
                            <p>
                                At XinFin, the security of our application is our first priority. As such, we strive to provide the most secure platform possible. We will evaluate reported security issues based on the security impact to our
                                users and the XinFin ecosystem.
                            </p>

                            <div class="linkbox">
                                <p>Steps to Become a Beta Tester for Google Play Apps</p>
                                <p>
                                    <a href="https://support.google.com/websearch/answer/6307673?hl=en" target="_blank">
                                        <button class="btn-hover color-3" data-toggle="modal" data-target="#exampleModalCenter">Click Here</button>
                                    </a>
                                </p>
                            </div>
        ...
        <div class="modal fade bs-example-modal-lg" id="exampleModalCenter-6" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title" id="exampleModalCenterTitle">Bug Bounty Program for testing XinFin Extension Wallet: XinPay</h3>
                    </div>
                    <div class="modal-body">
                        <div class="bounty">
                            <p>XinFin is happy to release the XinFin Extension Wallet: <strong>XinPay</strong></p>
                            ...
                            <div class="orderList">
                                <ol>
                                    <li>Please provide detailed reports with reproducible steps. If the report is not detailed enough to reproduce the issue, the issue will not be eligible for a reward.</li>
                                    ...
                                    <li>Phishing, Vishing, Smishing is prohibited.</li>
                            ...
                            <p class="sub-header-small mt-3 mb-1">Out of scope vulnerabilities:</p>
                            <p class="mb-1">The following issues are considered out of scope:</p>
                            <ul>
                            ...
                            <p>When reporting vulnerabilities, please consider attack scenario / exploitability, and security impact of the bug.</p>

                            <p class="sub-header-small mt-3 mb-1">Rewards:</p>
                            <p class="mb-2">Rewards are based on the Common Vulnerability Scoring Standard.</p>
        ...
        <div class="modal fade bs-example-modal-lg" id="exampleModalCenter-7" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title" id="exampleModalCenterTitle">Masternode Bounty Program</h3>
                    </div>
                    <div class="modal-body">
                        <div class="bounty">
        ...
        <div class="modal fade bs-example-modal-lg" id="exampleModalCenter-8" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered bounty-modal" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title" id="exampleModalCenterTitle">Masternode Luck User Bounty</h3>
                    </div>
                    <div class="modal-body">
                        <div class="bounty">
                            <p>
                                XinFin invites you all whether you are a <strong>financial institution, a federal agency a developer, or an individual</strong>, you can easily set-up a masternode using the one-click installer guide. XinFin
                                invites its existing as well as new global users to set-up masternode using a one-click installer function, and make an impact in the world of decentralized trade and finance. So,
                                <a href="https://medium.com/xinfin/steps-to-setup-masternode-on-xinfin-mainnet-bf66dda3ea1c" target="_blank">Setup Masternode</a> now and be a part of XinFin ecosystem.
                            </p>
