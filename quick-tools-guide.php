    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-9 col-md-12 hero-content">
                <h1 class="title-m text-center mb-0">XDC Chain Network Tools and Documents</h1>
                <h2 class="subtitle subtitle-s fw-500 text-center mb-0">
                    The XDC Chain Network provides a variety of tools and resources to help developers build and deploy applications on the blockchain. With its fast transaction speeds, low fees, and scalability, the XDC Chain Network is a
                    great choice for developing a wide range of applications.
                </h2>
            </div>
        </div>
    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-6 mb-5 mb-xl-0 mb-lg-0">
                                ...
                                <div class="btn-block d-block mt-4">
                                    <a href="https://xdcscan.io/" target="_blank"><button class="btn-blue mt-2">XDCScan MainNet</button></a>
                                    <a href="https://explorer.apothem.network/" target="_blank"><button class="btn-transp-bordered mt-2">XDCScan TestNet</button></a>
                                </div>
                            </div>
