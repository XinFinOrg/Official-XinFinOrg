        ...
        <div class="container">
            <div class="row row-flex">
                        ...
                        <div class="col-lg-3 col-md-6 mt-2 mb-2">
                            <div class="h-100 card p-4 bg-lightgray br-20 border-0">
                                    <div class="card-info">
                                        ...
                                        <p class="fs-6 mb-0">Masternodes are essential for transaction validation and processing on the XDC Network. They use their consensus and voting power to approve legitimate transactions, effectively thwarting fraudulent and malicious activities.</p>
                                    </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 mt-2 mb-2">
                            <div class="h-100 card p-4 bg-lightgray br-20 border-0">
                                    <div class="card-info">
                                        ...
                                        <p class="fs-6 mb-0">By facilitating InstantSend technology, Masternodes enable swift and near-instantaneous transaction confirmations. This feature enhances the network's usability, making it ideal for real-time applications.</p>
                                    </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 mt-2 mb-2">
                ...
                <div class="col-lg-12 mt-5">
                    <p class="subtitle subtitle-s fw-500 text-center mb-4">In summary, XDC Masternodes form the backbone of the network's security infrastructure, ensuring a safe, efficient, and resilient blockchain ecosystem for users and developers alike.</p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 mb-5">
                ...
                <div class="subtitle subtitle-s text-center">If you do not have the resources to maintain a masternode, there are a number of third-party services and volunteers willing to provide you with top-notch support and services.</div>
            </div>
        </div>
        <div class="row row-flex">
        ...
        <div class="row row-flex">
                <div class="col-lg-10 offset-lg-1 mt-4">
                        	<p class="subtitle text-center mb-0"><i><span class="fw-600">DISCLAIMER:</span> Please be advised that the third-party services listed do not constitute an endorsement by XDC and are provided for informational purposes only. Please exercise caution when using any third-party services, as it is outside of our control.</i></p>
                        </div>
            </div>
    </div>
</section>
...
<section class="px-80 bg-lightgray">
    <div class="container">
        ...
        <div class="row justify-content-center pb-5">
                        <div class="col-lg-5 col-md-5 mt-2 mb-2">
                            <div class="h-100 card p-4 dark-merg-gradient br-20 border-0">
                                    <div class="card-info">
                            ...
                            <div class="accordion accordion-flush fs-6" id="accordionFlushExample">
                              <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingOne">
                                  <button class="fw-500 accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">How can I set up Msternode on XDC Network?</button>
                                </h2>
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingTwo">
                                  <button class="fw-500 accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">Are there any risks associated with running a Masternode?</button>
                                </h2>
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingThree">
                                  <button class="fw-500 accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">Can I withdraw my rewards from the Masternode?</button>
                                </h2>
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingFour">
                                  <button class="fw-500 accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseFour">What's the benefit of running a Masternode?</button>
                                </h2>
