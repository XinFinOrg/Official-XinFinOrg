        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="row custodian-wallets justify-content-lg-start justify-content-md-start justify-content-sm-center">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                        <div>
                            <a href="ttps://www.blocksscan.io/" target="_blank">
...
<section class="px-80 pt-0 pb-2 dark-curved">
   <div class="container p-relative">
      ...
      <div class="row pt-5 mt-5">
         <div class="col-12">
            <div class="card p-5 bg-lightgray br-20 border-0">
               <div class="row align-items-center">
                  <div class="col-lg-6 col-md-12 mb-4 mb-md-4 mb-lg-0">
                     <h3 class="title-m text-center text-md-start text-lg-start mb-3">Protocol Lab</h3>
      ...
      <div class="row mt-5">
         <div class="col-12">
            <div class="card bg-transparent p-5 br-20 border-0">
               <div class="row align-items-center">
                  <div class="col-lg-6 col-md-12">
                     <div class="row custodian-wallets justify-content-lg-start justify-content-md-start justify-content-sm-center">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                  ...
                  <div class="col-lg-6 col-md-12 mb-4 mb-md-4 mb-lg-0">
                     ...
                     <h3 class="title-m text-center text-md-start text-lg-start mb-3">Infrastructure Integration Level Developers</h3>
                     <div class="subtitle subtitle-s text-center text-md-start text-lg-start">Safeguard Your Digital Assets for XDC Network with Trusted Custodian Wallet Services that supports XDC.</div>
                     <div class="orderList subtitle subtitle-s">
                        <ul class="checkmark">
                            <li>Wallet Connectors, Exchange Connectors, Custodian Connectors</li>
      ...
      <div class="row mt-5">
         <div class="col-12">
            <div class="card p-5 bg-lightgray br-20 border-0">
               <div class="row align-items-center">
                  <div class="col-lg-6 col-md-12 mb-4 mb-md-4 mb-lg-0">
                     <h3 class="title-m text-center text-md-start text-lg-start mb-3">Application Level Developers</h3>
                     <div class="subtitle subtitle-s text-center text-md-start text-lg-start">Safeguard Your Digital Assets for XDC Network with Trusted Custodian Wallet Services that supports XDC.</div>
                     <div class="orderList subtitle subtitle-s">
                        <ul class="checkmark">
                            <li>Smart contracts</li>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                ...
                <div class="subtitle subtitle-s text-center">
                    The XDC Community includes people of many different backgrounds and skillsets. Whether you're a developer, an artist, or an accountant, there are ways to get involved. Access XDC documents, ask in the XDC Forum, or join
                    Telegram's Developers community for assistance.
                </div>
            </div>
        </div>
        <div class="row mb-2">
