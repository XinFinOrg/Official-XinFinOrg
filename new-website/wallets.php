    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1 hero-content">
                <h1 class="title-m text-center mb-0">XDC Wallets<!--: Secure Transactions!--></h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                        <div class="row justify-content-center">
                                    ...
                                    <div class="exchangeCard-block card-info d-flex flex-column gap-4">
                                        ...
                                        <div class="d-flex justify-content-between">                                            
                                            <div class="pairs fw-500 ml-6">
                                                ...
                                                <a href="https://guarda.com/desktop/" target="_blank" title="Windows 32" class="WalletPlatform__link"><img src="assets/images/wallets/windows.svg"></a>
                            ...
                            <div class="col-lg-44 col-md-4 mt-2 mb-2">
                                <div class="h-100 card pt-4 pb-4 px-3 bg-lightgray br-20 border-0">
                                    <div class="exchangeCard-block card-info d-flex flex-column gap-4">
                                        <div class="exchangeCard-header">
                                            <div class="icon">
                            ...
                            <div class="col-lg-4 col-md-4 mt-2 mb-2">
                                <div class="h-100 card pt-4 pb-4 px-3 bg-lightgray br-20 border-0">
                                    <div class="exchangeCard-block card-info d-flex flex-column gap-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="pairs fw-500 ml-6">
                                                <a href="https://chrome.google.com/webstore/detail/simplehold/imeelmcnggkkokgfhinnjhjfilibhpaj" target="_blank" title="Hardware Wallet" class="WalletPlatform__link"><img src="assets/images/wallets/chrome.svg"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
