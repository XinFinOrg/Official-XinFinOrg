...
(function ($) {
    ...
    $(document).on("ready", function () {
		...
		var storedThemeMob = localStorage.getItem('theme') || (window.matchMedia("(prefers-color-scheme: darkTheme)").matches ? "darkTheme" : "lightTheme");
		const htmlTagMob = document.getElementsByTagName('body')[0];
		if (storedThemeMob)
			htmlTagMob.setAttribute('class', storedThemeMob)
